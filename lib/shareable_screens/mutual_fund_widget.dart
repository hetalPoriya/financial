...
class MutualFundWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> savedStrList = perf.getStringList('graphValue');
    incDesPer = savedStrList.map((i) => int.parse(i)).toList();
    print('index ${incDesPer.length}');
    print('total value $incDesPer');
    print('keyValue ${incDesPer.asMap().containsKey(24)}');
    print('value ${incDesPer[24].toDouble()}');
    ...
    print('lengthValue ${investmentGraph[25].currentValue}');
    return Padding(
            ...
            children: [
              ...
              Text(
                ...
                style: AllTextStyles.dialogStyleLarge(
                    size: 14.sp, fontWeight: FontWeight.w600),
              ),
              SizedBox(
                height: 1.h,
              ),
              ...
              Text(
                ...
                style: AllTextStyles.dialogStyleLarge(size: 12.sp),
              ),
              SizedBox(
                height: 1.h,
              ),
