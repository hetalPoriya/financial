...
import 'package:financial/utils/global_variable.dart';
...
class _AllQueLevelFiveState extends State<AllQueLevelFive> {
  ...
  getAllData() async {
    ...
    if (levelId == 0) {
      print('eeneeee');
      incDesPer = [];
      Prefs.remove(PrefString.graphValue);
    } else {
                                                                ...
                                                                if (levelFiveCon
                                                                  ...
                                                                  if (flag1 ==
                                                                    ...
                                                                    Fluttertoast
                                                                        .showToast(
                                                                            msg:
                                                                                AllStrings.optionAlreadySelected);
                                                                  }
                                                                }
                                                              },
                                                      ),
                                                                  ...
                                                                  : () async {
                                                                      ...
                                                                      if (balance >=
                                                                        ...
                                                                        firestore
                                                                          ...
                                                                          if (totalHomeLoan ==
                                                                              0)
                                                                            await Prefs.setInt(PrefString.rentPrice,
                                                                                0);
                                                                          if (totalTransportLoan ==
                                                                              0)
                                                                            await Prefs.setInt(PrefString.transportPrice,
                                                                                0);
                                                                          _setState(
                                                                              () {});
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  child: Text(
                                                                                    ...
                                                                                    style: AllTextStyles.workSansSmallBlack().copyWith(fontSize: 12.sp, fontWeight: FontWeight.w500),
                                                                                  ),
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                FittedBox(
                                                                              child: Text('Transport Loan Fully Paid', style: AllTextStyles.workSansExtraSmall()),
                                                                            ),
                                                                            style:
                                                                                ButtonStyle(
                                                                              backgroundColor: MaterialStateProperty.all(
                                                                        ...
                                                                        _setState(
                                                                          ...
                                                                          if (index == snapshot.data!.docs.length - 1 &&
                                                                            ...
                                                                            controller.nextPage(
                                                                                duration: Duration(milliseconds: 800),
                                                                                curve: Curves.easeIn);
                                                                            Prefs.setInt(PrefString.level4or5innerPageViewId,
                                                                                0);
                                                                          }
                                                                        });
                                                                      });
  ...
  _showDialogOfMutualFund(StateSetter setStateWidget) async {
    ...
    if (totalMutualFund == 0) {
      ...
      //   number = rnd.nextInt(6);
      // }
      number = randomNumberTotalPositive! <= 18
          ? rnd.nextInt(15 + 5) - 15
          : rnd.nextInt(16);
      print('number ${number}');
      if (number <= 0) {
