...
//                                       textStyle1:
//                                       AllTextStyles.gameQuestionOptionText(
...
//         'level_id': index + 1,
//         'level_1_id': index + 1,
//         'level_1_balance': balance,
//         'level_1_qol': qualityOfLife,
//       });
//       Future.delayed(
...
//                       }
//                       Get.offAll(() =>
//                           RateUs(onSubmit: () => onSubmit(value, qol)));
//                       //     () {
...
//   }
//
//   onSubmit(bool value, int qol) => popQuizDialog(
//     onPlayPopQuizPressed: () {
//       _whenLevelComplete(value: value, levelOrPopQuiz: 'Level_1_Pop_Quiz')
...
//       _whenLevelComplete(value: value, levelOrPopQuiz: 'Level_2_setUp_page')
//           .then((value) => Future.delayed(
//           Duration(seconds: 1),
//               () => Get.offAll(
//                 () => LevelTwoSetUpPage(),
