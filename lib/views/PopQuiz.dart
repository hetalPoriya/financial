                                                        ...
                                                        children: [
                                                          ...
                                                          options(() {
                                                            _checkCorrectAnswer(
                                                              ...
                                                              color2,
                                                              2),
                                                         if( popQuiz == 'Level_2_Pop_Quiz' ||  popQuiz == 'Level_3_Pop_Quiz') options(() {
                                                            _checkCorrectAnswer(
                                                                ans,
                                                                _setState,
                                                                document,
                                                                index,
                                                                3);
                                                          },index, document['option_3'], color3, 3),
                                                         if( popQuiz == 'Level_2_Pop_Quiz' ||  popQuiz == 'Level_3_Pop_Quiz') options(() {
                                                            _checkCorrectAnswer(
                                                                ans,
                                                                _setState,
                                                    ...
                                                    if (list[index].isSelected1 == true ||
                                                      ...
                                                      firestore
                                                        ...
                                                        'previous_session_info': popQuiz ==
                                                            ...
                                                            ? 'Level_3_setUp_page'
                                                            :  popQuiz ==
                                                            'Level_3_Pop_Quiz' ? 'Level_4_setUp_page' : 'Level_5_setUp_page',
                                                        // : 'Coming_soon',
                                                        'level_id': 0,
                                                        'bill_payment': 0,
                                                        'credit_card_balance':
