                                            ...
                                            onTap: () async {
                                              if (index1 == 0) {
                                                rentPrice = _controller
                                                    ...
                                                    .rent!;
                                                await Prefs.setInt(
                                                    PrefString.rentPrice, rentPrice);
                                              ...
                                              if (index1 == 1) {
                                                transportPrice = _controller
                                                    ...
                                                    .rent!;
                                                await Prefs.setInt(
                                                    PrefString.transportPrice, transportPrice);
                                              ...
                                              if (index1 == 2) {
                                                ...
                                                await Prefs.setInt(
                                                    PrefString.lifestylePrice, lifestylePrice);
                                                  ...
                                                  ? () async {
                                                      ...
                                                      if (index1 ==
                                                        ...
                                                        if (level ==
                                                          ...
                                                          await Prefs.setInt(
                                                              PrefString.level4TotalPrice, level4TotalPrice);
